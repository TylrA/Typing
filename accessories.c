...
int testFitness()
{
	...
	testResult(calcInRoll( 0,  1), AS * inRoll);
	testResult(calcInRoll(20, 21), 0);
	testResult(calcInRoll(10, 12), AD * inRoll);
	testResult(calcInRoll(10,  2), AD * inRoll);
	testResult(calcInRoll(29, 17), AD * inRoll);
	testResult(calcInRoll(20, 22), AD * inRoll);
	testResult(calcInRoll( 0,  2), AD * inRoll);
	testResult(calcInRoll(29,  7), 0);
	testResult(calcInRoll(22,  0), 0);
	testResult(calcInRoll(10,  1), 0);
	testResult(calcInRoll(10, 21), 0);
	testResult(calcInRoll(10,  3), AR * inRoll);
	testResult(calcInRoll(29, 16), AR * inRoll);
	testResult(calcInRoll(10, 23), AV * inRoll);
	testResult(calcInRoll( 9, 16), AV * inRoll);
	testResult(calcInRoll(10, 13), AF * inRoll);
	testResult(calcInRoll( 9,  6), AF * inRoll);
	testResult(calcInRoll(20, 23), AF * inRoll);
	testResult(calcInRoll(19,  5), AT * inRoll);
	testResult(calcInRoll(20, 14), AT * inRoll);
	testResult(calcInRoll(19, 25), AB * inRoll);
	testResult(calcInRoll( 0, 14), AB * inRoll);
	testResult(calcInRoll(19, 15), AG * inRoll);
	testResult(calcInRoll( 0,  4), AG * inRoll);
	testResult(calcInRoll(29, 25), AG * inRoll);
