...
int testFitness()
{
	...
	printf("\nTesting calcInRoll():\n");
	testResult(calcInRoll( 0,  0), 0);
	testResult(calcInRoll(10, 11), AS * inRoll + inRollOffset);
	testResult(calcInRoll(14, 15), 0);
	...
	testResult(calcInRoll(11,  2), 0);
	testResult(calcInRoll( 2, 11), 0);
	testResult(calcInRoll(10,  1), 0);
	testResult(calcInRoll(19, 28), 0);
	testResult(calcInRoll(11, 22), 0);
	testResult(calcInRoll(18,  7), 0);
	testResult(calcInRoll(12,  3), 0);
	testResult(calcInRoll(17,  5), 0);
	testResult(calcInRoll(22, 14), 0);
	testResult(calcInRoll( 0,  1), AS * inRoll + inRollOffset);
	testResult(calcInRoll(20, 21), 0);
	testResult(calcInRoll(10, 12), AD * inRoll + inRollOffset);
	testResult(calcInRoll(10,  2), AD * inRoll + inRollOffset);
	testResult(calcInRoll(29, 17), AD * inRoll + inRollOffset);
	testResult(calcInRoll(20, 22), AD * inRoll + inRollOffset);
	testResult(calcInRoll( 0,  2), AD * inRoll + inRollOffset);
	testResult(calcInRoll(29,  7), 0);
	testResult(calcInRoll(22,  0), 0);
	testResult(calcInRoll(10,  1), 0);
	testResult(calcInRoll(10, 21), 0);
	testResult(calcInRoll(10,  3), AR * inRoll + inRollOffset);
	testResult(calcInRoll(29, 16), AR * inRoll + inRollOffset);
	testResult(calcInRoll(10, 23), AV * inRoll + inRollOffset);
	testResult(calcInRoll( 9, 16), AV * inRoll + inRollOffset);
	testResult(calcInRoll(10, 13), AF * inRoll + inRollOffset);
	testResult(calcInRoll( 9,  6), AF * inRoll + inRollOffset);
	testResult(calcInRoll(20, 23), AF * inRoll + inRollOffset);
	testResult(calcInRoll(19,  5), AT * inRoll + inRollOffset);
	testResult(calcInRoll(20, 14), AT * inRoll + inRollOffset);
	testResult(calcInRoll(19, 25), AB * inRoll + inRollOffset);
	testResult(calcInRoll( 0, 14), AB * inRoll + inRollOffset);
	testResult(calcInRoll(19, 15), AG * inRoll + inRollOffset);
	testResult(calcInRoll( 0,  4), AG * inRoll + inRollOffset);
	testResult(calcInRoll(29, 25), AG * inRoll + inRollOffset);
	testResult(calcInRoll( 0, 23), 0);
	testResult(calcInRoll(29,  6), 0);
	testResult(calcInRoll(20,  4), 0);
	testResult(calcInRoll( 9, 25), 0);
	testResult(calcInRoll(11, 12), SD * inRoll + inRollOffset);
	testResult(calcInRoll( 8,  7), SD * inRoll + inRollOffset);
	testResult(calcInRoll(21, 22), XC * inRoll + inRollOffset);
	testResult(calcInRoll(28, 26), XV * inRoll + inRollOffset);
	testResult(calcInRoll(21, 24), XV * inRoll + inRollOffset);
	testResult(calcInRoll( 8,  5), SG * inRoll + inRollOffset);
	testResult(calcInRoll(11, 14), SG * inRoll + inRollOffset);
	testResult(calcInRoll( 8,  6), SF * inRoll + inRollOffset);
	testResult(calcInRoll(11, 13), SF * inRoll + inRollOffset);
	testResult(calcInRoll(18,  6), SR * inRoll + inRollOffset);
	testResult(calcInRoll(11, 23), SR * inRoll + inRollOffset);
	testResult(calcInRoll( 8, 16), SR * inRoll + inRollOffset);
	testResult(calcInRoll( 1, 14), SB * inRoll + inRollOffset);
	testResult(calcInRoll(18, 25), SB * inRoll + inRollOffset);
	testResult(calcInRoll(11,  4), SB * inRoll + inRollOffset);
	testResult(calcInRoll(27, 26), CV * inRoll + inRollOffset);
	testResult(calcInRoll(22, 24), CV * inRoll + inRollOffset);
	testResult(calcInRoll(12, 13), DF * inRoll + inRollOffset);
	testResult(calcInRoll( 7,  6), DF * inRoll + inRollOffset);
	testResult(calcInRoll(12, 14), DG * inRoll + inRollOffset);
	testResult(calcInRoll( 7,  5), DG * inRoll + inRollOffset);
	testResult(calcInRoll(12, 23), DV * inRoll + inRollOffset);
	testResult(calcInRoll(17, 25), DB * inRoll + inRollOffset);
	testResult(calcInRoll( 2, 13), EF * inRoll + inRollOffset);
	testResult(calcInRoll( 7, 15), EG * inRoll + inRollOffset);
